...
class TestGetFilesInfo(unittest.TestCase):
    ...
    def test_absolute_path_outside_working_directory(self):
        ...
        self.assertIn('Cannot list "/bin" as it is outside the permitted working directory', result)
    ...
    def test_parent_directory_escape_attempt(self):
        ...
        # Should return an error string
        self.assertTrue(result.startswith("Error:"))
        self.assertIn('Cannot list "../" as it is outside the permitted working directory', result)
